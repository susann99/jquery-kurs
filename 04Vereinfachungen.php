...
//                    alert(index + ': ' + value);
//                   alert('index:'+index % arrColor.length);
//                });
...
//                });
                ...
                //                   $('#contentLeft  li:not(:eq(0)) p').css("display","none");
                ...
                $("#contentLeft  li").click(function(){
                    ...
                    //$("#contentLeft li").children("p[display=block]").css("display","none");
                    //$("#contentLeft li").children("p[display!=none]").css("display","none");
