...
/*            img[name=home2]{
        ...
        <script src="js/srplugin2.js"></script>
...
//                 new ImgFade("bilder2");
    ...
    <body>
        <div id="bilder"> 
                  ...
                  <img class="bildhome" name="home3" id="home3" src="images/amelia_earhart3.jpg" width="267" height="188">
                  <img class="bildhome" name="home4" id="home4" src="images/amelia_earhart4.jpg" width="267" height="188">
        </div>        
    </body>
</html>